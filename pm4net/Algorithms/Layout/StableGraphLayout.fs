...
type StableGraphLayout private() =
    ...
    static member ComputeGlobalOrder (rankGraph, skeleton, components, discoveredModel) =
        ...
        GraphLayoutAlgo.minimizeEdgeCrossings globalOrder skeleton rankGraph discoveredModel //|> GraphLayoutAlgo.convertGlobalOrderToFriendlyFormat
